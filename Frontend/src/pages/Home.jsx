              ...
              {submitted ? (
                <div className="h-full flex flex-col items-center justify-center space-y-6 text-center">
                   <div className="bg-green-50 p-6 rounded-full mb-2">
                     <CheckCircle2 className="w-20 h-20 text-cricket-green" />
                   </div>
                   <h2 className="text-3xl font-black text-slate-800">Registration Successful!</h2>
                   <p className="text-slate-600 text-lg font-medium">Your details and payment proof have been received. We will verify and contact you shortly.</p>
                   <button 
                      onClick={() => setSubmitted(false)}
                      className="mt-8 px-8 py-3 bg-slate-100 text-slate-700 rounded-xl font-bold hover:bg-slate-200 transition-colors shadow-sm"
                   >
                      ...
                      <div className="space-y-2 text-center">
                        ...
                        <div className="flex text-sm text-slate-600 justify-center font-medium">
                          <label className="relative cursor-pointer rounded-md text-cricket-green hover:text-green-700 focus-within:outline-none">
                            <span className="bg-white px-3 py-1 rounded-md border border-green-200 shadow-sm">
